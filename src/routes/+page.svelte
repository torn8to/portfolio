...
<svelte:head>
  <title>Nathan Rogers - Main page</title>
</svelte:head>

<main
  class="flex flex-col justify-center items-center min-h-[calc(100vh-168px)] text-center px-5"
>
  <div class="w-full max-w-[800px] mx-auto">
    ...
    <div class="flex justify-center items-center gap-10 mt-[40px]">
      ...
      <div
        class="w-[50px] h-[50px] md:w-[60px] md:h-[60px] flex items-center justify-center"
      >
        <Tooltip tooltip="Email me">
          <div
            role="button"
            tabindex="0"
            class="text-white hover:text-[#ca3c25] transition-colors w-full h-full"
      ...
      >
        <Tooltip tooltip="LinkedIn">
          <a
            href="https://www.linkedin.com/in/nathanrogers22433b199"
            aria-label="LinkedIn"
            target="_blank"
            rel="noopener noreferrer"
            class="text-white hover:text-[#ca3c25] transition-colors w-full h-full"
